...
merge; use 5/5 when no material issues remain. Use 3/5 only for a confirmed,
high-impact issue that merits prompt follow-up but does not block merging.
...
the score for a concern with any Medium or Low rating.
